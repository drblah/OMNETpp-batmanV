///*
// *  types.h
// *  Adapted from types.h of batman-adv version 2018.0
// *
// */
//#include "inet/batman/routing/BATMANV_ControlPackets_m.h"
//#include "inet/batman/routing/batadv_definitions.h"
//#include "inet/linklayer/common/MACAddress.h"
//
//#ifndef INET_BATMAN_BATMAN_V_TYPES_H_
//#define INET_BATMAN_BATMAN_V_TYPES_H_
//
///* To use the BATMAN_V Routing Algorithm */
//#define CONFIG_BATMAN_ADV_BATMAN_V
//
//namespace inet {
//
///********** Addded defines, typedefs, structs and classes **********/
...
//class batadv_priv_bla;
//class batadv_priv_dat;
//class batadv_priv_tvlv;
//class batadv_priv_bat_v;
//class batadv_priv_mcast;
//
//class batadv_orig_node;
//class batadv_orig_ifinfo;
//class batadv_orig_bat_iv;
//class batadv_orig_bat_v;
//class batadv_orig_node_vlan;
//
...
//class batadv_bla_claim;
//class batadv_softif_vlan;
//class batadv_socket_client;
//class batadv_bla_backbone_gw;
//class batadv_frag_list_entry;
//class batadv_frag_table_entry;
//
///********** End addded defines, typedefs, structs and classes **********/
//
...
////         */
////        batadv_orig_ifinfo *last_bonding_candidate;
////
////    #ifdef CONFIG_BATMAN_ADV_DAT
...
////        batadv_frag_table_entry fragments[BATADV_FRAG_BUFFER_COUNT];
////
////        /**
...
////        uint64_t throughput; // Exponentially Weighted Moving Average (EXMA)_throughput
////
////        /** @elp_interval: time interval between two ELP transmissions */
////        simtime_t elp_interval;
////
...
////        batadv_hardif_neigh_node_bat_v bat_v;
////    #endif
////        /** @refcount: number of contexts the object is used */
////        struct kref refcount;
////        /** @rcu: struct used for freeing in a RCU-safe manner */
...
////        /** @bat_v: B.A.T.M.A.N. V private data */
////        batadv_neigh_ifinfo_bat_v bat_v;
...
//        uint32_t bcast_seqno;
//        /**
//         * @bcast_queue_left: number of remaining buffered broadcast packet
//         *  slots
//         */
//        unsigned int bcast_queue_left;
//        /** @batman_queue_left: number of remaining OGM packet slots */
//        unsigned int batman_queue_left;
...
//         */
//        batadv_hard_iface *primary_if;  /* rcu protected pointer */
...
//     *  (optional)
//     */
//    void (*activate)(batadv_hard_iface *hard_iface);
//    /** @enable: init routing info when hard-interface is enabled */
//    int (*enable)(batadv_hard_iface *hard_iface);
//    /** @disable: de-init routing info when hard-interface is disabled */
//    void (*disable)(batadv_hard_iface *hard_iface);
//    /**
//     * @update_mac: (re-)init mac addresses of the protocol information
//     *  belonging to this hard-interface
//     */
//    void (*update_mac)(batadv_hard_iface *hard_iface);
//    /** @primary_set: called when primary interface is selected / changed */
//    void (*primary_set)(batadv_hard_iface *hard_iface);
//};
//
///**
...
//    void (*hardif_init)(batadv_hardif_neigh_node *neigh);
//    /**
//     * @cmp: compare the metrics of two neighbors for their respective
//     *  outgoing interfaces
//     */
//    int (*cmp)(batadv_neigh_node *neigh1,
//           batadv_hard_iface *if_outgoing1,
//           batadv_neigh_node *neigh2,
//           batadv_hard_iface *if_outgoing2);
//    /**
//     * @is_similar_or_better: check if neigh1 is equally similar or better
//     *  than neigh2 for their respective outgoing interface from the metric
//     *  prospective
//     */
//    bool (*is_similar_or_better)(batadv_neigh_node *neigh1,
//                     batadv_hard_iface *if_outgoing1,
//                     batadv_neigh_node *neigh2,
//                     batadv_hard_iface *if_outgoing2);
//#ifdef CONFIG_BATMAN_ADV_DEBUGFS
//    /** @print: print the single hop neighbor list (optional) */
//    void (*print)(batadv_priv *priv, struct seq_file *seq);
//#endif
...
//     */
//    void (*free)(batadv_orig_node *orig_node);
//    /**
//     * @add_if: ask the routing algorithm to apply the needed changes to the
//     *  orig_node due to a new hard-interface being added into the mesh
//     *  (optional)
//     */
//    int (*add_if)(batadv_orig_node *orig_node,
...
//     *  (optional)
//     */
//    int (*del_if)(batadv_orig_node *orig_node,
...
//    void (*init_sel_class)(batadv_priv *bat_priv);
//    /**
//     * @store_sel_class: parse and stores a new GW selection class
//     *  (optional)
//     */
//    ssize_t (*store_sel_class)(batadv_priv *bat_priv, char *buff,
//                   size_t count);
//
//    /** @show_sel_class: prints the current GW selection class (optional) */
//    ssize_t (*show_sel_class)(batadv_priv *bat_priv, char *buff);
//    /**
//     * @get_best_gw_node: select the best GW from the list of available
//     *  nodes (optional)
//     */
//    batadv_gw_node *(*get_best_gw_node)
//        (batadv_priv *bat_priv);
//    /**
//     * @is_eligible: check if a newly discovered GW is a potential candidate
//     *  for the election as best GW (optional)
//     */
//    bool (*is_eligible)(batadv_priv *bat_priv,
//                batadv_orig_node *curr_gw_orig,
//                batadv_orig_node *orig_node);
//#ifdef CONFIG_BATMAN_ADV_DEBUGFS
//    /** @print: print the gateway table (optional) */
//    void (*print)(batadv_priv *bat_priv, struct seq_file *seq);
//#endif
...
//     */
//    void (*ogm_handler)(batadv_priv *bat_priv,
//                batadv_orig_node *orig,
//                uint8_t flags, void *tvlv_value, uint16_t tvlv_value_len);
//    /**
//     * @unicast_handler: handler callback which is given the tvlv payload to
//     *  process on incoming unicast tvlv packets
//     */
//    int (*unicast_handler)(batadv_priv *bat_priv,
...
//     */
//    BATADV_TVLV_HANDLER_OGM_CIFNOTFND = BIT1,
//    /**
...
//     */
//    BATADV_TVLV_HANDLER_OGM_CALLED = BIT2,
//};
//
///**
...
//} /* namespace inet */
//
//#endif /* INET_BATMAN_BATMAN_V_TYPES_H_ */
